...
const UnifiedDashboard = () => {
  ...
  useEffect(() => {
    const calculateOptimalTokens = () => {
      ...
      const currentPhase = vaultInfo.currentPhase !== undefined ? Number(vaultInfo.currentPhase) : 0; // 0 = DEPOSIT
      setEffectivePhase(currentPhase);

      if (currentPhase === 0) { // DEPOSIT phase
      ...
      } else if (currentPhase === 2) { // CLAIMS phase
